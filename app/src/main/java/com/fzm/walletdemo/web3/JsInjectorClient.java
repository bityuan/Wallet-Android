package com.fzm.walletdemo.web3;

import static com.fzm.walletdemo.web3.util.Utils.loadFile;
...
public class JsInjectorClient {
    ...
    {
        return loadFile(context, R.raw.min);
    }
    ...
    String injectWeb3TokenInit(Context ctx, String view, String tokenContent, BigInteger tokenId)
    {
        ...
        String nodeUrl = "https://rpc.ankr.com/eth";

        String initSrc = loadFile(ctx, R.raw.init_token);
        //put the view in here
        String tokenIdWrapperName = "token-card-" + tokenId.toString(10);
        initSrc = String.format(initSrc, tokenContent, walletAddress, nodeUrl, chainId, tokenIdWrapperName);
