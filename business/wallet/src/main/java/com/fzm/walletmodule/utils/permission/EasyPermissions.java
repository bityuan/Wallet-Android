 ...
 */
package com.fzm.walletmodule.utils.permission;
...
public class EasyPermissions {
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        if (shouldShowRationale) {
            ...
            showDialog(activity, rationale, object, requestCode, perms);
    ...
    private static void showDialog(Activity activity, String rationale, final Object object, final int requestCode, final String... perms){
        ...
        View vMiddleLine = rootView.findViewById(R.id.v_middle_line);
        vMiddleLine.setVisibility(View.GONE);
        tvResult.setText(activity.getString(R.string.per_upload));
        tvResultDetails.setText(rationale);
        btnLeft.setText(activity.getString(R.string.cancel));
        btnRight.setText(activity.getString(R.string.ok));
